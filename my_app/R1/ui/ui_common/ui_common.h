...
LV_IMG_DECLARE(JPG);
LV_IMG_DECLARE(catalog);
LV_IMG_DECLARE(speaking);
LV_IMG_DECLARE(icon_ai_talk_listening);
LV_IMG_DECLARE(icon_ai_talk_thinking);
LV_IMG_DECLARE(icon_translate_failed);
LV_IMG_DECLARE(icon_ai_talk_user_logo);
LV_IMG_DECLARE(icon_ai_talk_robot_logo);
#if 0
...
#define     Chinese_font_Bold_24    lv_font_unifont_16
#define     EX_Chinese_font_36      lv_font_aliPuHui_36
#endif
